...
("BIB-13","An Introduction to Statistical Learning","James, Witten, Hastie, Tibshirani","statistica","T2","Accesso libero degli autori","https://www.statlearning.com/","pdf","PDF ufficiale gratuito, edizioni R e Python."),
("BIB-14","The Elements of Statistical Learning","Hastie, Tibshirani, Friedman","statistica","T2","Accesso libero degli autori","https://hastie.su.domains/ElemStatLearn/","pdf","Versione avanzata del precedente."),
("BIB-15","Causal Inference: What If","Hernán & Robins","epidemiologia","T2","Accesso libero degli autori","https://miguelhernan.org/whatifbook","pdf","Confondimento, causalità, bias. Il testo più utile per il tuo dominio."),
...
("BIB-29","NIST AI Risk Management Framework 1.0","NIST","ia","T3","Pubblico dominio","https://www.nist.gov/itl/ai-risk-management-framework","pdf","Govern, Map, Measure, Manage."),
...
("BIB-38","NIST SP 800-61 — Incident Handling Guide","NIST","sicurezza","T5","Pubblico dominio","https://csrc.nist.gov/pubs/sp/800/61/r2/final","pdf","Sequenza di risposta agli incidenti."),
("BIB-39","NIST SP 800-34 — Contingency Planning Guide","NIST","hardware","T5","Pubblico dominio","https://csrc.nist.gov/pubs/sp/800/34/r1/upd1/final","pdf","RTO, RPO, continuità operativa."),
("BIB-40","NIST SP 800-124 — Mobile Device Security","NIST","hardware","T5","Pubblico dominio","https://csrc.nist.gov/pubs/sp/800/124/r2/final","pdf","Gestione di flotte di dispositivi sul campo."),
...
("BIB-47","Sphere Handbook","Sphere Association","meal","T6","Accesso libero","https://spherestandards.org/handbook/","pdf","Standard minimi. Disponibile anche in italiano."),
("BIB-48","Core Humanitarian Standard","CHS Alliance","meal","T6","Accesso libero","https://corehumanitarianstandard.org/the-standard","pdf","I nove impegni."),
("BIB-49","Evaluation of Humanitarian Action Guide","ALNAP","meal","T6","Accesso libero","https://www.alnap.org/help-library/evaluation-of-humanitarian-action-guide","pdf","Metodologia di valutazione umanitaria."),
("BIB-50","SMART Methodology Manual","SMART Initiative","epidemiologia","T6","Accesso libero","https://smartmethodology.org/survey-planning-tools/smart-methodology/","pdf","Campionamento a grappoli, design effect, indagini nutrizionali."),
